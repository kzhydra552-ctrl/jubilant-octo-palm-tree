...
const FILTER_VERSION = 'explicit-channel-filters-v6-single-ws';
...
const connection = { label: 'DEX', url: WS_URL, secret: SECRET_KEY, reconnectDelay: 2000, reconnectTimer: null, socket: null };
