...
const FILTER_VERSION = 'explicit-channel-filters-v9-dual-lura-ws';
// Segurança: o ambiente local permanece desligado por padrão. No Railway, use ENABLE_DEX_WS=true.
